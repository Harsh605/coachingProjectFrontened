    ...
    return (
        <>
           <div className="flex items-center min-h-screen p-4 bg-gray-100 lg:justify-center">
                ...
                >
                    <div
                        className="p-4 py-6 text-white bg-[#5b58ff] md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly"
                    >
                        <div className="my-3 text-4xl font-bold tracking-wider text-center">
                            <span>Coaching</span>
                        </div>
                        <p className="mt-6 font-normal text-center text-gray-300 md:mt-0 hidden md:block">
                        Our coaching empowers you with knowledge and strategies to achieve exam success.
                        </p>
                        ...
                        <p className="mt-6 text-sm text-center text-gray-300">
                            Read our <a href="#" className="underline text-[white]">terms</a> and <a href="#" className="underline text-[white]">conditions</a>
                        </p>
                    </div>
                    <div className="p-5 bg-white md:flex-1">
                        <h3 className="my-4 text-2xl font-semibold text-gray-700">Register Now</h3>
